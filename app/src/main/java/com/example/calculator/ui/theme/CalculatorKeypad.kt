...
import com.example.calculator.model.ButtonKind
import com.example.calculator.model.CalculatorAction
import com.example.calculator.model.CalculatorButtonUi

@Composable
fun CalculatorKeypad(
    modifier: Modifier = Modifier,
    clearLabel: String = "AC",
    onAction: (CalculatorAction) -> Unit
) {
    val clearAction = if (clearLabel == "AC") CalculatorAction.Clear else CalculatorAction.ClearEntry
